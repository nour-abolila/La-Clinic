            ...
            <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
                ...
                <div
                    ...
                    <div class="support-box text-end d-none d-xl-block">
                        ...
                        <h5 class="mb-0">+201062482101</h5>
                    </div>
                    <div class="support-box text-end d-none d-xl-block">
                        <span class="fs-6 secondary-font text-muted">Email</span>
                        <h5 class="mb-0">nour@gmail.com</h5>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="pages">
                                    ...
                                    <li><a href="/cat-shop" class="dropdown-item">Cat Shop</a></li>
                                    <li><a href="/" class="dropdown-item">Cart</a></li>
                                    {{-- <li><a href="index.html" class="dropdown-item">Wishlist</a></li> --}}
                                    <li><a href="/dog-shop" class="dropdown-item">Dog Shop</a></li>
            ...
            <div class="row">
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="{{ asset('assets/images/blog1.jpg') }}"
        ...
        <div class="row g-0 py-5">
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                    <iconify-icon class="text-white" icon="la:github"></iconify-icon>
                </div>
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta1.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                ...
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta2.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                ...
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta3.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                ...
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta4.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                ...
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta5.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
            <div class="col instagram-item  text-center position-relative">
                <div class="icon-overlay d-flex justify-content-center position-absolute">
                ...
                <a href="https://github.com/nour-abolila">
                    <img src="{{ asset('assets/images/insta6.jpg') }}" alt="insta-img" class="img-fluid rounded-3">
                </a>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="footer-menu">
                        ...
                        <p class="blog-paragraph fs-6 mt-3">Subscribe to my social media to follow updates.</p>
                        <div class="social-links">
                            <ul class="d-flex list-unstyled gap-2">
                                <li class="social">
                                    <a href="https://www.facebook.com/nour.abo.lila300">
                                ...
                                <li class="social">
                                    <a href="https://www.linkedin.com/in/nourabolila">
                                        <iconify-icon class="social-icon" icon="ri:linkedin-fill"></iconify-icon>
                                    </a>
                                </li>
                                <li class="social">
                                    <a href="https://www.instagram.com/nour_abolila120">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-md-6 copyright">
                    <p class="secondary-font">© 2026 Nour Abo Lila. All rights reserved.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="secondary-font"> Distributed by <a href="https://www.linkedin.com/in/nourabolila"
                            target="_blank" class="text-decoration-underline fw-bold text-black-50"> Nour Abo Lila</a>
                    </p>
                </div>
            </div>
        </div>
